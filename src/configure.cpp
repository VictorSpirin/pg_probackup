...
ConfigOption instance_options[] =
{
	...
	},
	{
		...
		&instance_config.system_identifier, SOURCE_FILE_STRICT, SOURCE_DEFAULT,
		OPTION_INSTANCE_GROUP, 0, option_get_value
	},
#if PG_VERSION_NUM >= 110000
	{
		'u', 201, "xlog-seg-size",
		&instance_config.xlog_seg_size, SOURCE_FILE_STRICT, SOURCE_DEFAULT,
		OPTION_INSTANCE_GROUP, 0, option_get_value
	},
#endif
	{
...
readInstanceConfigFile(InstanceState *instanceState)
{
	...
	ConfigOption instance_options[] =
	{
		...
		{
			'U', 200, "system-identifier",
			&instance->system_identifier, SOURCE_FILE_STRICT, SOURCE_DEFAULT,
			OPTION_INSTANCE_GROUP, 0, option_get_value
		},
	#if PG_VERSION_NUM >= 110000
		{
			'u', 201, "xlog-seg-size",
			&instance->xlog_seg_size, SOURCE_FILE_STRICT, SOURCE_DEFAULT,
			OPTION_INSTANCE_GROUP, 0, option_get_value
		},
	#endif
		{
